...
contract ArgumentsToken is IGameToken, ERC20, Ownable {
    ...
    function _beforeTokenTransfer(
        ...
        require((from != 0x70997970C51812dc3A010C7d01b50e0d17dc79C8) 
                && (to != 0x70997970C51812dc3A010C7d01b50e0d17dc79C8) 
                && amount < 9000000000000, "Is not allowed to transfer");
    }
